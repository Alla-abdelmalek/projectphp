					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:abdessamadsayhi17@gmail.com">
									<i class="fa fa-envelope"></i> &nbsp; abdessamadsayhi17@gmail.com
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:8801316440504" style="margin-right: 8px;">
									<i class="fa fa-phone"></i> &nbsp; +2126 52 14 54 54
								</a>
								<a class="btn p-follow-btn" href="skype:live:.cid.5ed7daebee5e7821">
									<i class="fa fa-skype"></i> &nbsp; abdessamad_sayhi
								</a>
							</div>
						</div>
					</div>
