...
<head>
	...
	<meta name="author" content="Abdessamad Sayhi">
			...
			<div class="header-top">
				<div class="container">
					<div class="header-left header-dropdowns">
						...
						<div class="header-dropdown">
							<a href="#"><img src="public/assets/images/favicon/bd.png" alt="Moroccan flag">Morocco</a>
							<div class="header-menu">
								<ul>
				...
				<div class="container">
					...
					<div class="header-right">
						...
						<div class="header-contact"><span>Call us now</span>
							<a href="tel:#"><strong>+212 6 52 14 54 52</strong></a>
						</div>
