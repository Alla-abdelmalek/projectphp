				...
				<div class="col-lg-4 col-md-6">
					<div class="widget">
						<ul class="contact-info">
							<li><span class="contact-info-label">Address:</span>Lazaret, Oujda, Morocco</li>
							<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">(+212) 6 52 14 54 52</a></li>
							<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">abdessamadsayhi17@gmail.com</a></li>
	...
	<div class="container">
		<div class="footer-bottom">
			<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By
				<a href="//www.google.com" target="_blank"> Abdessamad Sayhi</a>
			</p>
			...
			<div class="social-icons">
				<a href="https://google.com target=" _blank" style="margin: 0px 10px;">
					<img src="public/assets/images/icons/aamroni.png" class="rounded-circle" style="width:32px; height:32px;">
				</a>
				<a href="https://www.facebook.com/profile0017/" class="social-icon" target="_blank">
					<i class="icon-facebook"></i>
				</a>
				<a href="https://www.linkedin.com/in/abdessamad-sayhi/" class="social-icon" target="_blank">
					<i class="icon-linkedin"></i>
				</a>
				<a href="https://twitter.com/SayhiAbdessamad" class="social-icon" target="_blank">
